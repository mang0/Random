...
#		This says that if what the user inputted is in the list skillNames, continue. If not, then it goes to line 64/5, and repeats, asking the user to check spelling.
...
#		All of this is very basic and easy to understand.	
